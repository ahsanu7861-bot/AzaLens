...
const {
  EQUITY_CONSTANTS, EXPECTED_COMPONENTS, POLICY_ARGUMENTS, RPC_NAMES, SCHEDULE_ARGUMENTS,
...
(async () => {
  ...
  db = mockDb({ rpcResult: { data: [{ schedule_version_id: IDS.schedule, version_no: 9e30, replayed: true }], error: null },
    tables: { broker_cost_schedule_versions: [{ id: IDS.schedule, version_no_text: "2" }] } });
