...
const root=path.resolve(__dirname,"../..");const up=fs.readFileSync(path.join(root,"supabase/migrations/20260919120000_008_personal_risk_lifecycle.sql"),"utf8");const down=fs.readFileSync(path.join(root,"db/down-migrations/20260919120000_008_personal_risk_lifecycle.sql"),"utf8");
...
}catch(e){primary=e;}finally{sql(up);}assert.equal(exists(),"1");if(primary)throw primary;
...
console.log("Migration 008 empty reversal, unchanged Migration 004 RPC/RLS suites, and exact reapplication passed.");
